...
import { listPageStyles } from "../../assets/themeStyles.js";
    ...
    <div className={listPageStyles.pageContainer}>
      <div className={listPageStyles.contentWrapper}>
        <div className={listPageStyles.headerContainer}>
          <div>
            <h1 className={listPageStyles.headerTitle}>Consultations Log</h1>
            <p className={listPageStyles.headerSubtitle}>
              Manage and reschedule your clinical consulting appointments.
            </p>
          </div>
        ...
        {loading ? (
          <div className={listPageStyles.loadingContainer}>
            ...
            <p className="mt-2 text-sm font-semibold">Loading appointments...</p>
          </div>
        ) : error ? (
          ...
          <div className={listPageStyles.appointmentsGrid}>
            {filtered.length > 0 ? (
                    ...
                    <div className={listPageStyles.cardHeader}>
                      <div className={listPageStyles.cardAvatar}>
                        <div className={listPageStyles.cardAvatarFallback}>
                          {(a.patient || "P").charAt(0).toUpperCase()}
                        </div>
                      </div>
              ...
              <div className="col-span-full text-center py-12 text-slate-500 font-medium italic">
                No doctor appointments found matching the filters.
              </div>
            )}
          </div>
        )}
